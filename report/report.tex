...
\author{Ali Rastegar Mojarad \\ \small Constructor Knowledge Labs --- PhD Assessment}
\date{\today}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.49\linewidth]{figures/t1_snapshots.pdf}\hfill
  \includegraphics[width=0.49\linewidth]{figures/t2_dendrogram_cuts.pdf}
  \caption{Left: node counts by type and hyper-edge arity distribution per snapshot.
  Right: illustrative dendrogram — three horizontal cuts yield the three hierarchy
  levels (12 / 60 / 300 clusters); actual data has 5,798 leaves.}
  \label{fig:overview}
\end{figure}
